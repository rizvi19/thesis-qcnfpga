// ============================================================================
// QFlow FDPE Kernel V2 — 128-entry LUT with linear interpolation
// Standalone ASIC/VLSI study kernel
//
// Difference from V1:
//   V1: 128-entry floor lookup only
...
//
// Research purpose:
//   Test whether 128-entry LUT + interpolation gives high accuracy with
//   acceptable generic synthesis cost.
// ============================================================================

`timescale 1ns/1ps

module fdpe_kernel_v2_lut128_interp #(
    parameter FID_W = 16,
    parameter IDX_W = 7,
    parameter FRAC_W = 8
)(
    ...
    assign next_index = (lut_index == 7'd127) ? 7'd127 : (lut_index + 7'd1);
