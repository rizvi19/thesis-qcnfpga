...
imbalance is smaller & Training increases balance emphasis; reported evaluation
uses the common $+1$ scale\\
...
Training uses balance coefficient 4 in the learning target and the three-decision
dwell mechanism. Validation and final reported metrics use balance coefficient 1 in
