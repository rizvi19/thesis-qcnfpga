...
\begin{equation}
r_t^{\mathrm{eval}}=4+2(0.6)+0.75-0.25(3)=5.20.
\end{equation}
With a profile change, $r_t^{\mathrm{eval}}=4.95$. When no candidate is feasible,
$r_t^{\mathrm{eval}}=r_t^{\mathrm{train}}=-4.00$ without a switch and $-4.25$
with one; the route terms are zero.
...
\begin{equation}
r_t^{\mathrm{train}}=4+2(0.6)+4(0.75)-0.25(3)=7.45.
\end{equation}
